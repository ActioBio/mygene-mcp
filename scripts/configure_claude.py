...
def find_python_executable():
    ...
    if hasattr(sys, 'real_prefix') or (hasattr(sys, 'base_prefix') and sys.base_prefix != sys.prefix):
        ...
        try:
            ...
            print("Error: mygene-mcp package not found in the current environment.", file=sys.stderr)
...
def test_server():
    ...
    try:
        import mygene_mcp.server
        print("✅ Server module imported successfully")
        return True
    except ImportError as e:
        print(f"Error: Failed to import mygene_mcp.server: {e}", file=sys.stderr)
